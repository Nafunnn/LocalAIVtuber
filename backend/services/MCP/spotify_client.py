...
SPOTIFY_SYSTEM_HINT = (
    ...
    "Pause/stop requests: call pausePlayback (required). "
    "Skip/next track: call skipToNext. Previous track: call skipToPrevious. "
    "Resume/continue or generic 'play spotify' / 'play music': call resumePlayback. "
    "Play a specific song: searchSpotify(query, type=\"track\") then playMusic with the track uri. "
    "playMusic with no uri resumes the current queue. "
